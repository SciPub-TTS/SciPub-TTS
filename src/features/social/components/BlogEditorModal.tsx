...
import { INPUT_CLASS, PRIMARY_BUTTON_CLASS, SECONDARY_BUTTON_CLASS, TAG_PILL_CLASS } from "@/features/social/constants/socialHub.constants";
import type { BlogFormState, BlogModalMode } from "@/features/social/types/social.types";
import { normalizeSocialOpenAlexId, normalizeTopicLabel } from "@/features/social/utils/socialFormatters";
        ...
        <form onSubmit={onSubmit} className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="min-h-0 flex-1 space-y-5 overflow-y-auto px-6 py-5">
            ...
            <div>
              ...
              <label className="mb-2 block text-sm font-extrabold uppercase tracking-[0.22em] text-[#14532D]">
                Write your insight <span className="text-slate-400">(optional)</span>
              </label>
              <textarea
            ...
            <div className="rounded-[1.2rem] border border-black bg-slate-50/60 p-4">
              ...
              <label className="mt-4 flex h-11 items-center gap-2 rounded-xl border border-black bg-white px-3 text-slate-500 focus-within:border-[#14532D] focus-within:text-[#14532D]">
                ...
                <input
                  ...
                  onChange={(event) => setBookmarkTitleQuery(event.target.value)}
