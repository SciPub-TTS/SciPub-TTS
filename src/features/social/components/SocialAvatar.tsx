...
export function SocialAvatar({
  ...
  return (
    <div
      className={`overflow-hidden rounded-full bg-[#EEF6FF] ${sizeClassName}`}
    >
      <img
      ...
      <span className="hidden h-full w-full items-center justify-center bg-[#14532D] text-sm font-semibold text-white">
        {initials}
      </span>
    </div>
  );
