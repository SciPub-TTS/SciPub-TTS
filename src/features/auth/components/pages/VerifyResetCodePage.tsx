...
export default function VerifyResetCodePage() {
    ...
    return (
        <AuthResetLayout backTo={ROUTES.FORGOT_PASSWORD} backLabel="Back">
            {/* Icon */}
            ...
            <h1 className="font-search-title text-[2.2rem] leading-[1.15] text-slate-950 mb-1">
                Check your
            </h1>
            <h1 className="font-search-title text-[2.2rem] leading-[1.15] italic text-emerald-700 mb-3">
                email.
            </h1>
